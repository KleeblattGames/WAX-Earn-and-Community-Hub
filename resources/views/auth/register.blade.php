                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-area">
                            <form method="POST" action="{{ route('register') }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="name" type="text" placeholder="Select a username" class="form-control input-field @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" required autocomplete="name" autofocus>
                        ...
                        <div class="form-footer">
                            <p class="text-[#939393]">Already registered?
                                <a class="text-[#8BE78B] self-end w-max text-decoration-underline underline-offset-4 text-xs sm:text-sm leading-[22px] hover:text-[#035c3c]" href="{{ route('login') }}">Login</a>
                            </p>
                        </div>
                    </div>
                </div>
