...
<head>
    ...
    <link href="{{ asset('assets/css/responsive.css') }}" rel="stylesheet">
    <link href="{{ asset('assets/css/tailwindcss.css') }}" rel="stylesheet">
                        ...
                        <nav class="navbar navbar-expand-lg navbar-light">
                            <div class="container-fluid p-0 flex items-center flex-nowrap gap-2 sm gap-0">
                                ...
                                <div class="navbar-collapse justify-content-end fixed-height d-flex gap-3 sm:gap-[15px]" id="main_menu">
                                    ...
                                    @guest
                                    @if (Route::has('login'))
                                    <a class="mybtnReg" href="{{ route('login') }}">LOGIN</a>
                                    {{-- <a href="#" class="mybtnReg" data-toggle="modal" data-target="#signin">LOGIN</a> --}}
                                    @endif
                                    @else
